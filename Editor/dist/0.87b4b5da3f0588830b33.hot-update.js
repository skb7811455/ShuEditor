...
Head.prototype = {
	...
	_initDom: function () {
		for (var i = 1; i <= 5; i++) {
			this.$hs.push(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__DomUtil_js__["a" /* default */])("<button><i class='fa fa-header fa-" + px + "x'></i></button>").attr("sign", "h" + i).css("width", "30px"));
