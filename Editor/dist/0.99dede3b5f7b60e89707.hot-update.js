...
(function (window) {
	...
	Editor1.prototype = {
		...
		_initDom: function () {
			...
			const $menuElem = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__DomUtil_js__["a" /* default */])('<ul></ul>').css("width", "100%").attr("id", "s-e-menu" + shuEditorId).addClass("s-e-menu").css("backgound-color", menuColor);
			const $textElem = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__DomUtil_js__["a" /* default */])('<div></div>').css('width', "100%").addClass("s-e-container").attr("contenteditable", true).attr("id", "s-e-container" + shuEditorId);
