...
(function (window) {
	...
	Editor.prototype = {
		...
		_initDom: function () {
			...
			const $menuElem = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__DomUtil_js__["a" /* default */])('<ul></ul>').css("width", "100%").attr("id", "s-e-menu" + shuEditorId).addClass(menuSelector).css("background", menuColor);
			const $textElem = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__DomUtil_js__["a" /* default */])('<div></div>').css('width', "100%").addClass(textSelector).attr("contenteditable", true).attr("id", "s-e-container" + shuEditorId);
	...
	Editor1.prototype = {
		...
		_initDom: function () {
			const menuColor = this.config.menuColor;
			console.log(this.config.menuColor);
			const $menuElem = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__DomUtil_js__["a" /* default */])('<ul></ul>').css("width", "100%").attr("id", "s-e-menu" + shuEditorId).addClass("s-e-menu").css("background", menuColor);
