...
Head.prototype = {
	...
	_initDom: function () {
		for (var i = 0; i < 5; i++) {
			this.$hs.push(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__DomUtil_js__["a" /* default */])("<button>H1</button>").attr("sign", "h" + i + 1));
			this.$elem.append(this.$hs[i]);
		}
