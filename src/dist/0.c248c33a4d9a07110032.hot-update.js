...
(function (window) {
	...
	Editor.prototype = {
		...
		_initDom: function () {
			...
			const $textElem = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__DomUtil_js__["a" /* default */])('<div></div>').css('width', "100%")
			//.addClass("s-e-container")
			.addClass(textSelector).attr("contenteditable", true).attr("id", "s-e-container" + shuEditorId);
