...
function Head(editor) {
	const html = '<div><span>H</span><ul class="s-e-list"><li>h1</li><li>h2</li><li>h3</li></ul></div>';
	this.editor = editor;
	this.$elem = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__DomUtil_js__["a" /* default */])(html).addClass("s-e-menuList");
	this._acitive = false;
}
Head.prototype = {
