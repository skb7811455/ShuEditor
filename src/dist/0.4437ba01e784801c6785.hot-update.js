...
Bold.prototype = {
	...
	init: function () {
		...
		Object.defineProperty(this, "book", {
			...
			set: function () {
				console.log(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__DomUtil_js__["a" /* default */])("bold").ele.firstChild);
				__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__DomUtil_js__["a" /* default */])("bold").ele.firstChild.value = this.book;
			}
		});
		this.book = 111;
	},
