...
function File(editor) {
    this.editor = editor;
    this.$elem = $("<div><img src='add.jpeg'><input type='file'></a><button type='button'><i class='fa fa-file'></i></button><button><i class='fa fa-camera'></i></button></div>").addClass("s-e-file");
    this.type = 'click';
